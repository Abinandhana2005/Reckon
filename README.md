...
The project includes 384 passing automated tests covering classification, market semantics, acknowledgement behaviour, data-source isolation, simulations, and API behaviour.
